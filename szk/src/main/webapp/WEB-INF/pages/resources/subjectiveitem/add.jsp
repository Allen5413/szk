...
<form class="am-form" id="addForm" name="addForm" method="post">
  ...
  <div class="am-g am-margin-top">
    ...
    <div class="am-u-sm-4">
      <!-- 加载编辑器的容器 -->
      <script id="add_subjectiveitem_reference" name="reference" type="text/plain"></script>
      <!-- 配置文件 -->
      ...
      <script type="text/javascript">
        var ue = UE.getEditor('add_subjectiveitem_reference');
      </script>
    </div>
  ...
  <div class="am-g am-margin-top">
    ...
    <div class="am-u-sm-8">
      <!-- 加载编辑器的容器 -->
      <textarea id="add_answer"></textarea>
      <!-- 实例化编辑器 -->
      <script type="text/javascript">
        var ue2 = new UE.ui.Editor({initialFrameHeight:70});
        ue2.render("add_answer");
      </script>
    </div>
