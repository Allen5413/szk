...
<form class="am-form am-form-horizontal" style="margin-top: 10px;" id="editForm" method="post">
  ...
  <div class="am-g am-margin-top">
    ...
    <div class="am-u-sm-4">
      <input class="am-input-sm" type="text" placeholder="输入编号" required id="edit_code" name="code" value="${productType.code}"  />
    </div>
  ...
  <div class="am-g am-margin-top">
    ...
    <div class="am-u-sm-4">
      <input class="am-input-sm" type="text" placeholder="输入名称" required id="edit_name" name="name" value="${productType.name}"  />
    </div>
    <div class="am-u-sm-5">*必填，不可重复</div>
  </div>
</form>