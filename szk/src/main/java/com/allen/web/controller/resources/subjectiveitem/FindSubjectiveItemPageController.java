 ...
 */
@Controller
@RequestMapping(value = "/findSubjectiveItemPage")
public class FindSubjectiveItemPageController extends BaseController {

    @Resource
    private FindSubjectiveItemPageService findSubjectiveItemPageService;

    @RequestMapping(value = "open")
    public String open() throws Exception {
        return "/resources/subjectiveitem/page";
    }
    ...
    public JSONObject find(@RequestParam(value="name", required=false) String name,
        ...
        pageInfo = findSubjectiveItemPageService.find(pageInfo, params, sortMap);
