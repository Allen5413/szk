 ...
 */
@Controller
@RequestMapping("/addTeachResources")
public class AddTeachResourcesController extends BaseController {

    @Resource
    private AddTeachResourcesService addTeachResourcesService;
    @Resource
    ...
    public JSONObject add(HttpServletRequest request,
        ...
        addTeachResourcesService.add(teachResources, StringUtil.isEmpty(labels) ? null : labels.split(","), UserUtil.getLoginUserForName(request));
